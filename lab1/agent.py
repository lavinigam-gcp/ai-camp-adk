# Lab 1: Getting Started - Coffee Shop Assistant (Python Version)
# This lab demonstrates the basics of creating an ADK agent using Python

from google.adk import Agent

# Create a friendly coffee shop assistant agent
root_agent = Agent(
